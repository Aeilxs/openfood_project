...
export class ApiService {
    private readonly url = 'https://world.openfoodfacts.org/cgi/search.pl';
    ...
    /**
     * Fetches a list of products based on the provided search filters.
     * Transforms the raw API data into your defined Product interface.
    ...
    /**
     * Converts a SearchFilters object into HttpParams.
            ...
            nutriments: raw.nutriments
                ? {
                      ...
                      proteins: raw.nutriments.proteins
                          ...
                          : undefined,
                      salt: raw.nutriments.salt ? Number(raw.nutriments.salt) : undefined,
                  }
                : undefined,
